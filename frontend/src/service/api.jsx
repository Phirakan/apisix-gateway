...
const ADMIN_KEY = 'edd1c9f034335f136f87ad84b625c8f1'; // Default admin key from config
...
export const api = {
  ...
  // Setup initial routes (helper function)
  setupInitialRoutes: async () => {
    try {
      // Create WordPress route
